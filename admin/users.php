		  ...
		  <div class="col-xl-12">
			 <div class="card">
				<div class="card-body" style="padding-left:80px;">
				   ...
				   <h4 class="box-link"><a href="manage_users.php">ADD </a> </h4>
				</div>
				<div class="card-body--">
						 ...
						 <tbody>
							...
							<tr>
							   ...
							   <td>
								<?php
								if($row['status']==1){
									echo'<p class="badge badge-complete"><a href="status.php?id='.$row['id'].'&status=0">Active</a></p>&nbsp';
								}else{
									echo '<p class="badge badge-pending"><a href="status.php?id='.$row['id'].'&status=1">Deactive</a></p>&nbsp';
								}
