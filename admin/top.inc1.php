         ...
         <header id="header" class="header">
            <div class="top-left">
               <div class="navbar-header">
                  <a class="navbar-brand" href="index1.php"><img src="images/image.png" alt="Logo"></a>
                  <a class="navbar-brand hidden" href="index1.php"><img src="images/image.png" alt="Logo"></a>
